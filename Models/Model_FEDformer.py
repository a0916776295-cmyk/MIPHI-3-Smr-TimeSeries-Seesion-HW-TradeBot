...
from tensorflow.keras.layers import Input, Dense, Dropout, LayerNormalization, Conv1D, MaxPooling1D, Flatten
import warnings
...
def train_and_predict_fedformer(df: pd.DataFrame, forecast_days: int):
    """
    Упрощенная FEDformer модель
    Использует частотное представление через Conv1D
    """
    ...
    # Построение упрощенной FEDformer модели
    inputs = Input(shape=(seq_length, 1))
    
    # Многоуровневая сверточная архитектура
